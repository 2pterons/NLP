# -*- coding: utf-8 -*-
"""7-8.translator(data).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1gunXQlEkc84aqxqYq7onRRFKGkaZy9IX
"""

# 한국어-영어 기계번역 교육을 위한 데이터를 생성한다.
# 기계번역 연구를 위해서는 AI Hub (https://aihub.or.kr/aidata/87)에서 제공하는 160만개의 번역 데이터를
# 사용할 수 있지만, 재배포 금지 규정 등이 있어서, 본 교육에서는 챗봇 데이터를 구글 번역기로 영어로
# 번역한 후 기계번역 프로그램을 실습하는 것으로 한다.
# 기계번역으로 프로젝트를 수행할 팀은 AI Hub 사이트에서 데이터를 다운로드 받아서 프로젝트를 수행한다.
