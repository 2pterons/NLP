...
e_layer = Embedding(input_dim=vocab_size, output_dim=EMBEDDING_DIM)(x_input) #(none, 7, 8)

flatten_layer = Flatten()(e_layer)
hidden_layer = Dense(HIDDEN_DIM, activation='tanh')(flatten_layer)
U = Dense(vocab_size)(hidden_layer)

W = Dense(vocab_size)(flatten_layer)
# 
add_layer = Add()([U,W])
...
for pred in predictions:
  ...
  pred_y.append(idx2word[np.argmax(pred)])
...
for i in range(len(test_text)):
  print('입력단어: ',test_text[i],' 출력단어:',pred_y[i])
# 입력단어:  ['the', 'cat', 'is']  출력단어: walking
# 입력단어:  ['a', 'dog', 'was']  출력단어: running
# 입력단어:  ['dog']  출력단어: was
# 입력단어:  ['the', 'bedroom']  출력단어: was
# 입력단어:  ['a', 'cat', 'is']  출력단어: running
# 입력단어:  ['a', 'was', 'walking']  출력단어: in
